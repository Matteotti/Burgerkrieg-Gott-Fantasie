...
public class Map : MonoBehaviour
{
    ...
    #region Debug变量，release时删除

    public Vector2Int 在这里输入要查看的坐标;
    public GameObject 二维数组查看器;

    #endregion

    #region 供给MapManager调用的方法组
    ...
    #region Debug方法组，release时删除

    void Debug()
    {
        二维数组查看器 = MapGrids[在这里输入要查看的坐标.x, 在这里输入要查看的坐标.y];
    }
